...
export const INGREDIENT_LIST = [
  ...
  { label: "Чеддер", value: "cheddar" },
  { label: "Салями", value: "salami" },
  { label: "Ветчина", value: "ham" },
  { label: "Ананас", value: "ananas" },
  { label: "Бекон", value: "bacon" },
  { label: "Лук", value: "onion" },
  { label: "Чили", value: "chile" },
  { label: "Халапеньо", value: "jalapeno" },
  { label: "Маслины", value: "olives" },
  { label: "Томаты", value: "tomatoes" },
  { label: "Лосось", value: "salmon" },
  { label: "Моцарелла", value: "mozzarella" },
